    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form role="form" method="POST" enctype="multipart/form-data" action="{{ route('backend.product.storeimages', $product_id) }}">
                    {{ csrf_field() }}
                    <div class="card-body">
                    ...
                    <div class="card-footer">
                        ...
                        <button type="submit" class="btn btn-sucess">Thêm ảnh</button>
                    </div>
                </form>
            </div>
        </div>
